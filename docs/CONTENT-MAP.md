...
The complete catalog of the workbook (`workbook/agentic-development-study.html`, v1.11):
8 modules, 52 topics, 6 research reports, 2 inline map sections, 12 deep-dive companions.
...
`P1-ai-assisted-discovery` · `P2-prds-with-ai` · `P3-decomposition`

Overlay anchors wired in the workbook: `#sdlc-deepdive`, `#e1-deepdive` … `#e8-deepdive`,
`#p1-deepdive` … `#p3-deepdive` (each appears exactly twice: the "Go deeper" link + the JS
open handler).
