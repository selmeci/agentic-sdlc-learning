...
8 modules, 52 topics, 6 research reports, 2 inline map sections, 21 deep-dive companions.
...
`I1-artifact-taxonomy` · `I2-lifecycle-write-permissions`

Overlay anchors wired in the workbook: `#sdlc-deepdive`, `#e1-deepdive` … `#e8-deepdive`,
`#p1-deepdive` … `#p5-deepdive`, `#d1-deepdive`, `#h1-deepdive` … `#h4-deepdive`, `#i1-deepdive`, `#i2-deepdive` (each appears
