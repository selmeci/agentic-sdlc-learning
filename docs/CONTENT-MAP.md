...
8 modules, 52 topics, 6 research reports, 2 inline map sections, 23 deep-dive companions.
...
`#p1-deepdive` … `#p5-deepdive`, `#d1-deepdive`, `#h1-deepdive` … `#h4-deepdive`, `#i1-deepdive` … `#i4-deepdive` (each appears
